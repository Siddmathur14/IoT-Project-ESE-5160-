...
// }
/**
 * @fn		    uint16_t pulsemain(void)
 * @brief       Runs heart rate measurement task
 * @details 	Runs heart rate measurement task 

 * @return		Returns ADC signal value.
 * @note
 */
