...
static const CLI_Command_Definition_t xTemperatureSensorGetTemperature = {"gettemp",
	"gettemp: Returns the temperature from the SHTC3 Sensor.\r\n",
	(const pdCOMMAND_LINE_CALLBACK)CLI_TemperatureSensorGetTemperature,
0};
...
BaseType_t CLI_TemperatureSensorGetTemperature(char *pcWriteBuffer, size_t xWriteBufferLen, const int8_t *pcCommandString)
  {  
		...
		uint8_t buffer[64];
		uint8_t buffer1[64];
		/*int state=SHTC3_Init();
		snprintf((char *) buffer1, sizeof(buffer1), "Temp : %d\r\n", buf);
		SerialConsoleWriteString(buffer1);
		snprintf((char *) buffer1, sizeof(buffer1), "Status of Temp init:  %d\ r\n", state);
		SerialConsoleWriteString(buffer1);
		state=SHTC3_SendI2cCommand(SHT3_TH_NM_NCS_MEASURE_CMD, sizeof(SHT3_TH_NM_NCS_MEASURE_CMD));
		snprintf((char *) buffer1, sizeof(buffer1), "Status of Temp cmd:  %d \r\n", state);
		SerialConsoleWriteString(buffer1);
		state=SHTC3_Read_Data(&buf, sizeof(buf));
		snprintf((char *) buffer1, sizeof(buffer1), "Status of Temp read:  %d \r\n", state);
		SerialConsoleWriteString(buffer1);
		snprintf((char *) buffer1, sizeof(buffer1), "Temp :  %d\r\n", buf);
		SerialConsoleWriteString(buffer1);*/
...
/////////////////////////////////SHTC3//////////////////////////////////////////////////////////////////////////////////////////////
	   ...
	   // int32_t BPM1 =pulsemain();
	   //WifiAddHeartrateDataToQueue(&BPM1);
	   
// 	    snprintf((char *) buffer1, sizeof(buffer1), "BPM : %d\r\n",BPM1 );
// 	    SerialConsoleWriteString(buffer1);
/////////////////////////////////SHTC3//////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////// DRV ////////////////////////////////////////////////////////////////////////////////////////////	
		...
		// 	snprintf((char *) buffer1, sizeof(buffer1), "Status : %d\r\n",state );
		// 	SerialConsoleWriteString(buffer1);
		// 	state= DRV2605_MODE_SELECT();
		// 	snprintf((char *) buffer1, sizeof(buffer1), "Status of mode : %d\r\n",state );
		// 	SerialConsoleWriteString(buffer1);
		// //	state= DRV2605_WAVEFORM(); //DRV2605_MOTOR_SELECT();
		// 	snprintf((char *) buffer1, sizeof(buffer1), "Status of MOTOR SELECT : %d\r\n",state );
		// 	SerialConsoleWriteString(buffer1);
		// //	state= DRV2605_Vibrations();// DRV2605_LIB_SELECT();
		// 	snprintf((char *) buffer1, sizeof(buffer1), "Status of LIB SELECT : %d\r\n",state );
		// 	SerialConsoleWriteString(buffer1);
		// 	state= DRV2605_DRIVE();
		// 	snprintf((char *) buffer1, sizeof(buffer1), "Status of DRIVE : %d\r\n",state );
		// 	SerialConsoleWriteString(buffer1);
